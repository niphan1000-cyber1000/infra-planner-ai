...
export const Header: React.FC = () => {
  ...
  return (
    <nav
      id="navbar"
      className="h-16 border-b border-white/5 bg-[#05070a]/80 backdrop-blur-md px-4 md:px-6 flex items-center justify-between z-30 shrink-0"
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-sm font-bold text-white tracking-wide">
            สถาปนิกโครงข่ายระบบ AI อัจฉริยะ
          </h1>
          <p className="text-[10px] text-indigo-300/70 font-medium">
            Enterprise Cloud & Hybrid Architecture Sandbox
          </p>
        </div>
      </div>
