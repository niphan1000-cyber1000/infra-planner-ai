export const swaggerDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "API Documentation for Enterprise IT Architect AI system. This API provides advanced IT/Cloud architecture recommendation engine powered by Google Gemini, live chatbot advisor, and system stress simulation endpoints.",
    contact: {
  ...
  paths: {
    "/health": {
      get: {
        ...
        description:
          "Returns the operational status of the server and the current server timestamp.",
        responses: {
          "200": {
    ...
    "/analyze-architecture": {
      post: {
        ...
        description:
          "Utilizes Gemini AI to design a customized enterprise architecture based on user constraints (Business Type, Compliance, Budget, Cloud Preference, Legacy Tech, and Risk Focus). Returns detailed nodes, connectors, constraints, bottlenecks, recommendations, and strategic plans.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
                    ...
                    nodes: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          type: {
                            type: "string",
                            enum: ["client", "network", "compute", "storage", "security", "legacy"],
                          },
                          tier: {
                            type: "string",
                            enum: ["client", "ingress", "app", "data", "integration"],
                          },
    ...
    "/chat-advisor": {
      post: {
        ...
        description:
          "Engages in interactive technical dialogue with the system architect AI. Receives context from previous requirements and chat history to provide answers to DevOps, Terraform, Cloud security, cost tuning, and migration challenges.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
                ...
                schema: {
                  ...
                  properties: {
                    reply: {
                      type: "string",
                      example:
                        "สำหรับการลดต้นทุนฐานข้อมูลในสถาปัตยกรรมนี้ คุณสามารถเปิดใช้งาน Auto-scaling storage และเลือกประมวลผลเป็นแบบ Serverless DB...",
                    },
                  },
                },
              },
